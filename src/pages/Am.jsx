    ...
    return (
        <>
            ...
            <div>
                ...
                <Cloud />
                <div>
                    <section className="text-[#ffffff] font-[700] sm:text-[56px] text-[32px] flex flex-col">
                        <div className="bg-gradient-to-b from-[#D3CDCF] to-[#0F1212] to-80% h-[25vh] w-screen"></div>
                        <Who />
                        <MyStory />
